<template>
  <el-card>
    ...
    <el-dialog v-model="dialogVisible" :title="editId ? '编辑门店' : '新增门店'" width="500px">
...
function showDialog(row) { editId.value = row?.id || null; if (row) Object.assign(form, row); else Object.assign(form, { name: '', address: '', phone: '', status: 1 }); dialogVisible.value = true }
